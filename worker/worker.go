...
func NewWorker() Worker {
	...
	movies_metadata_clean := clean.NewCleanMovies(movies_metadata, []string{"qtest"}) //"filter_release_date_ge_2000_and_include_ar", "filter_one_production_country", "map_sentiment_rate"
