...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_SENTIMENTRESPONSE']._serialized_end=113
  _globals['_SENTIMENTANALYZER']._serialized_start=115
  _globals['_SENTIMENTANALYZER']._serialized_end=204
